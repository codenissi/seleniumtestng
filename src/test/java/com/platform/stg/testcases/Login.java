...
public class Login {
	...
	public void testBookAppointment() {
		...
		// Add Goal Setter
		//driver.findElement(By.xpath("//input[@id=\"text\"]")).sendKeys("Goal Automation5");
		//driver.findElement(By.xpath("//button[normalize-space()=\"Add Goal\"]")).click();
		
		// Verify Goal label text that has been added - Locating the element
		//WebElement TextElement = driver.findElement(By.xpath("//h2[normalize-space()=\"Goal Automation5\"]"));
